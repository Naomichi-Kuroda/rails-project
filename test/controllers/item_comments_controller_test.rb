...
class ItemCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_comment" do
    assert_difference('ItemComment.count') do
      post item_comments_url, params: { item_comment: { body: @item_comment.body, item_id: @item_comment.item_id, status: @item_comment.status, user_id: @item_comment.user_id } }
    end
  ...
  test "should update item_comment" do
    patch item_comment_url(@item_comment), params: { item_comment: { body: @item_comment.body, item_id: @item_comment.item_id, status: @item_comment.status, user_id: @item_comment.user_id } }
