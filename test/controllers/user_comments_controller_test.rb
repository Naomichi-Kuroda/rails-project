...
class UserCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_comment" do
    assert_difference('UserComment.count') do
      post user_comments_url, params: { user_comment: { body: @user_comment.body, character_id: @user_comment.character_id, deleted: @user_comment.deleted, name: @user_comment.name } }
    end
  ...
  test "should update user_comment" do
    patch user_comment_url(@user_comment), params: { user_comment: { body: @user_comment.body, character_id: @user_comment.character_id, deleted: @user_comment.deleted, name: @user_comment.name } }
